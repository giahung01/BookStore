...
class ListCategoryBooks extends StatefulWidget {
  final String category;

  const ListCategoryBooks({super.key, required this.category});
...
class _ListState extends State<ListCategoryBooks> {
